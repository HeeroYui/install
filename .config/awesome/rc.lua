...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "Left",
        ...
        {description="Move to the previous view (LEFT)", group="tag"}
        ),
    awful.key({ modkey,           }, "Right",
        ...
        {description="Move to the naxt view (RIGHT)", group="tag"}
	),
    awful.key({ modkey,           }, "s",
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "y",      function (c) awful.titlebar.toggle(c)         end,
